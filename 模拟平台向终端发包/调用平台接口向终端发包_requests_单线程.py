...
def get_platform_pid():
    ...
    s.connect(hostname='192.168.11.1', port=22, username='root', password='xxxxxxxx')
...
def push_auth_pass_info(route_mac, m):
    ...
    while True:
        ...
        r = requests.post("http://xxxxxxxxx:9999/cloud/command?token=xxx", json=user_info)
